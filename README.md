...
- **Keyboard navigation** Every action has a keyboard shortcut (uses common browser defaults where possible): `Ctrl+L`, `Ctrl+F`, `Ctrl+R`, `Ctrl+H`, `Ctrl+D`, `Ctrl+B`, `Alt+Left`. Press `?` for the card.
